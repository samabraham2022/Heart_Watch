      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-4"><label>Heart_Rate:</label></div>
                  <div class="col-md-8"><input type="Heart_Rate" class="form-control"  onkeyup='check();' name="dHeart_Rate" id="dHeart_Rate"  required></div><br><br>
                  <div class="col-md-4"><label>Confirm Heart_Rate:</label></div>
                  <div class="col-md-8"  id='cpass'><input type="Heart_Rate" class="form-control" onkeyup='check();' name="cdHeart_Rate" id="cdHeart_Rate" required>&nbsp &nbsp<span id='message'></span> </div><br><br>
